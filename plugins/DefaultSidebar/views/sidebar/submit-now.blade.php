<x-website::sidebar  class="sidebar-submit-now" :id="$id" >
    <div class="card card-compact bg-white border">
        <div class="card-body">
            <a href="{{ $submissionUrl }}" rel="nofollow" class="flex items-center">
                <h2 class="ml-1 text-base text-primary">Submit Now</h2>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-10 h-10 fill-primary text-white ms-auto">
