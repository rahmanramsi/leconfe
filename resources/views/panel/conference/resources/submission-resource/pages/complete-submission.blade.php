<x-filament::page>
    <div class="mx-auto max-w-xl w-full space-y-6">
        ...
        <x-filament::card>
          ...
          <br/>
          <p class="text-center">
            Go to <a href="{{ App\Panel\Series\Resources\SubmissionResource::getUrl('index') }}" class="text-primary-700">Submissions Page</a> to check the status of your submission.
          </p>
        </x-filament::card>
    </div>
</x-filament::page>
