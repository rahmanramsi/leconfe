...
@if ($scheduledConference->isArchived())
    <section id="archive-serie">
        <div role="alert" class="alert alert-warning">
            ...
            <span>You are viewing an archived scheduled conference</span>
        </div>
    </section>
@elseif($scheduledConference->isUpcoming())
    <section id="upcoming-serie">
        <div role="alert" class="alert alert-info">
            ...
            <span>You are viewing an upcoming scheduled conference</span>
        </div>
    </section>
@elseif($scheduledConference->isDraft())
    <section id="draft-serie">
        <div role="alert" class="alert alert-warning">
            ...
            <span>You are viewing a draft scheduled conference</span>
        </div>
    </section>
@endif
