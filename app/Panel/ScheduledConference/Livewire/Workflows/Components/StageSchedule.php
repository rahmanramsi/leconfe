...
namespace App\Panel\ScheduledConference\Livewire\Workflows\Components;
...
class StageSchedule extends Component implements HasActions, HasForms
{
    ...
    {
        return view('panel.scheduledConference.livewire.workflows.components.stage-schedule');
    }
}
